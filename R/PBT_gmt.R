...
#'@usage data(PBT_gmt)
#'
#'@references Halloran PF, De Freitas DG, Einecke G, \emph{et al.}, The
#'molecular phenotype of kidney transplants: Personal viewpoint,
#'\emph{Am J Transplant}, 10: 2215-2222, 2010.
#'.
#'
#'@references Sellares J, Reeve J, Loupy A, et al., Molecular diagnosis of
#'antibody-mediated rejection in human kidney transplants,
#'\emph{Am J Transplant}, 13:971-983, 2013.
#'
#'@references Broin PO, Hayde N, Bao Y, et al.,  A pathogenesis-based transcript
