...
`tcgsaseq` is the legacy companion package of the 2017 Agniel & Hejblum [*Biostatistics*](https://academic.oup.com/biostatistics/article-abstract/18/4/589/3065599) article.
It has been archived on CRAN and will not be further developped or extended.
...
The easiest way to get `tcgsaseq` is to install it from [GitHub](https://github.com/denisagniel/tcgsaseq):
